...
async function loadCategoryContent(category, container) {
    try {
        ...
        const url = `https://content.guardianapis.com/search?q=${encodeURIComponent(category)}&api-key=${API_KEY}&show-fields=thumbnail,trailText&page-size=19&order-by=${orderBy}`;
